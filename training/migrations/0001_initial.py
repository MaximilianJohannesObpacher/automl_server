# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2019-02-13 11:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('training_name', models.CharField(default='Unnamed', max_length=256)),
                ('framework', models.CharField(choices=[('auto_keras', 'Auto-keras'), ('auto_sklearn', 'Auto-sklearn'), ('tpot', 'TPOT')], max_length=24)),
                ...
                ('training_data_filename', models.CharField(blank=True, default='merged_folds_training_x.npy', help_text='Filename or path to the training data file originating from ml_data folder', max_length=256, null=True)),
                ('training_labels_filename', models.CharField(blank=True, default='merged_folds_training_y.npy', help_text='Filename or path to the training labels file originating from ml_data folder', max_length=256, null=True)),
                ('validation_data_filename', models.CharField(blank=True, default='merged_folds_validation_x.npy', help_text='Filename or path to the validation data file originating from ml_data folder', max_length=256, null=True)),
                ('validation_labels_filename', models.CharField(blank=True, default='merged_folds_validation_y.npy', help_text='Filename or path to the validation labels file originating from ml_data folder', max_length=256, null=True)),
                ('training_time', models.CharField(blank=True, help_text='training time until completion or interrupt (in seconds)', max_length=128, null=True)),
                ...
                ('load_files_from', models.CharField(choices=[('preprocessing_job', 'Preprocessing Job Output'), ('filename', 'filename')], default='filename', help_text='Decide wether you want to load your files from a filepath or a grab the output files of a preprocessing job you triggered before', max_length=32)),
                ('task_type', models.CharField(blank=True, choices=[('binary_classification', 'binary classification'), ('multiclass_classification', 'multiclass classification')], help_text='If undefined we automatically perform multiclass classification', max_length=32, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ErrorLog',
        ...
        migrations.CreateModel(
            name='AutoKerasTraining',
            fields=[
                ('automltraining_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='training.AutoMlTraining')),
                ('time_limit', models.IntegerField(blank=True, null=True)),
                ('verbose', models.BooleanField(default=True)),
            ],
            bases=('training.automltraining',),
        ),
        migrations.CreateModel(
            name='AutoSklearnTraining',
            fields=[
                ('automltraining_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='training.AutoMlTraining')),
