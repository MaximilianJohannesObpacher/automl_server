...
class AutoKerasTrainingAdmin(admin.ModelAdmin):
    ...
    def get_fieldsets(self, request, obj=None):
        fieldsets = (
            ('General Info:', {'fields': (
            'training_name', 'status', 'machine_id', 'date_trained', 'model_link', 'additional_remarks', 'training_time', 'verbose',
...
admin.site.register(AutoKerasTraining, AutoKerasTrainingAdmin)
